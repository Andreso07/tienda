...
urlpatterns = [
    ...
    path('usuarios/',include('usuarios.urls'), name='usuario'),
    
    path('tienda/',include('tiendaDia.urls')),
    path('admin/', admin.site.urls),

    path('logout/', logout_then_login,name='logout'),
    path('reset/password_reset',password_reset,{'template_name':'registration/password_reset_form.html',
                                                'email_template_name':'registration/password_resete_email.html'}, name='password_reset'),
